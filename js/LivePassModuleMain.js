function ConvivaPrivateModule() {}(function() {
	function yR(x7, l3) {
	...
	with({
		...
		with({
			...
			Ti.v1 = function(GC) {
				if (!this.E_(GC)) throw new Error("checkBuffer::missing bytes");
			};
			Ti.Dz = function(tO, length) {
				...
				if (tO < 0 || length <= 0) return 0;
				this.v1(tO + length);
				for (var dd, uS = tO % 8, E1 = this.yt.length - (tO >> 3) - 1, Mc = this.yt.length + (-(tO + length) >> 3), nx = E1 - Mc, gG = ((this.yt[E1] >> uS) & ((1 << (nx ? 8 - uS : length)) - 1)) + (nx && (dd = (tO + length) % 8) ? (this.yt[Mc++] & ((1 << dd) - 1)) << (nx-- << 3) - uS : 0);
				nx;
		...
		Ti.rj = function(rU) {
			if (this.Wk) throw new Error(rU);
			return 1;
		};
		Ti.e5 = function(jV, Oq, vc) {
			var jl = new this.p2(this.qs, jV);
			jl.v1(Oq + vc + 1);
			var qR = Math.pow(2, vc - 1) - 1,
				Pf = jl.Dz(Oq + vc, 1),
				A8 = jl.Dz(Oq, vc),
				FO = 0,
				Ve = 2,
				E1 = jl.yt.length + (-Oq >> 3) - 1;
			do
			for (var ZV = jl.yt[++E1], w9 = Oq % 8 || 8, FL = 1 << w9; FL >>= 1;
			(ZV & FL) && (FO += 1 / Ve), Ve *= 2);
			while (Oq -= w9);
		...
		Ti.te = function(jV, Oq, vc) {
			...
			if (M6[(xR = Oq - 1 + (co = (LU = qR + 1 - co) >= aH && LU <= gP ? co + 1 : qR + 1 - (LU = aH - 1))) + 1]) {
				if (!(_L = M6[xR])) for (Bs = xR + 2; !_L && Bs < Wp; _L = M6[Bs++]);
				for (Bs = xR + 1; _L && --Bs >= 0;
				(M6[Bs] = !M6[Bs] - 0) && (_L = 0));
			}
			for (co = co - 2 < 0 ? -1 : co - 3; ++co < Wp && !M6[co];);
			if ((LU = qR + 1 - co) >= aH && LU <= gP)++co;
			else if (LU < aH) {
		...
		Ti.qb = function(jV) {
			return this._9(jV, 8, true);
		};
		Ti.Mx = function(jV) {
			return this.h6(jV, 8, true);
		};
		Ti.ph = function(jV) {
			return this._9(jV, 8, false);
		};
		Ti.vb = function(jV) {
			return this.h6(jV, 8, false);
		};
		Ti.s1 = function(jV) {
			return this._9(jV, 16, true);
		};
		Ti.kZ = function(jV) {
			return this.h6(jV, 16, true);
		};
		Ti.eR = function(jV) {
			return this._9(jV, 16, false);
		};
		Ti.ko = function(jV) {
			return this.h6(jV, 16, false);
		};
		Ti.so = function(jV) {
			return this._9(jV, 32, true);
		};
		Ti.yu = function(jV) {
			return this.h6(jV, 32, true);
		};
		Ti.PB = function(jV) {
			return this._9(jV, 32, false);
		};
		Ti.T5 = function(jV) {
			return this.h6(jV, 32, false);
		};
		Ti.I_ = function(jV) {
			return this.e5(jV, 23, 8);
		};
		Ti.AU = function(jV) {
			return this.te(jV, 23, 8);
		};
		Ti.qM = function(jV) {
			return this.e5(jV, 52, 11);
		};
		Ti.Dv = function(jV) {
			return this.te(jV, 52, 11);
		};
	};
	va = function(_W) {
		var ii = _W.length;
	...
	IF = function(rS) {
		...
		for (var co = 0; co < Vn; co++) {
			JU = rS[co];
			if ((JU & 0x80) == 0x00) {} else if ((JU & 0xf8) == 0xf0) {
				rM = rS[co + 1];
				dL = rS[co + 2];
				V1 = rS[co + 3];
	...
	function CandidateStream() {
		...
		dN(up, CandidateStream, "QKZ", UuP);
		dN(up, CandidateStream, "ConstructClone", UuP);
	...
	function ConvivaContentInfo() {
		...
		ED(up, "K_y", oZN);
		ED(up, "useStrictChecking", oZN);

		function oZN() {
			return up.a4c;
		}
		Wf(up, "K_y", YiA);
		Wf(up, "useStrictChecking", YiA);
		...
		ED(up, "Sc", FZ);
		ED(up, "candidateResources", FZ);

		function FZ() {
			return oL.R5(up.ta);
		}
		Wf(up, "Sc", vQ);
		Wf(up, "candidateResources", vQ);
		...
		ED(up, "fi", fWP);
		ED(up, "resourceSelection", fWP);

		function fWP() {
			return up.oLs;
		}
		Wf(up, "fi", E8J);
		Wf(up, "resourceSelection", E8J);
		...
		ED(up, "N_", C7);
		ED(up, "monitoringOptions", C7);

		function C7() {
			return oL.uM(up.wwE);
		}
		Wf(up, "N_", Bv);
		Wf(up, "monitoringOptions", Bv);
		...
		ED(up, "hTs", M0F);
		ED(up, "resourceStateOverride", M0F);

		function M0F() {
			return up.wUp;
		}
		Wf(up, "hTs", fEY);
		Wf(up, "resourceStateOverride", fEY);
		...
		ED(up, "eQZ", mH1);
		ED(up, "frameworkName", mH1);

		function mH1() {
			return up.Db8;
		}
		Wf(up, "eQZ", cx_);
		Wf(up, "frameworkName", cx_);
		...
		ED(up, "Jqo", YNQ);
		ED(up, "frameworkVersion", YNQ);

		function YNQ() {
			return up.TSp;
		}
		Wf(up, "Jqo", hHp);
		Wf(up, "frameworkVersion", hHp);
		...
		ED(up, "wL2", BVV);
		ED(up, "pluginName", BVV);

		function BVV() {
			return up.IFU;
		}
		Wf(up, "wL2", m7Y);
		Wf(up, "pluginName", m7Y);
		...
		ED(up, "alT", KHz);
		ED(up, "pluginVersion", KHz);

		function KHz() {
			return up.XTh;
		}
		Wf(up, "alT", wTu);
		Wf(up, "pluginVersion", wTu);
		...
		ED(up, "lTq", OHw);
		ED(up, "deviceType", OHw);

		function OHw() {
			return up.J24;
		}
		Wf(up, "lTq", bmQ);
		Wf(up, "deviceType", bmQ);
		...
		ED(up, "qMR", WNr);
		ED(up, "playerName", WNr);

		function WNr() {
			return up.tUj;
		}
		Wf(up, "qMR", tz2);
		Wf(up, "playerName", tz2);
		...
		dN(up, ConvivaContentInfo, "XxO", EDi);
		dN(up, ConvivaContentInfo, "createInfoForLightSession", EDi);
		...
		dN(up, ConvivaContentInfo, "_C", q6);
		dN(up, ConvivaContentInfo, "sanitizeString", q6);
		...
		function q6(nI, Rd, vH, Sj) {
			...
			var h7 = oL.fg(nI);
			h7 = oL.xO(h7);
			if (vH && h7 == O9.Mul) {} else if (h7.length >= 3 && oL.n0(h7, 0, 3) == "c3.") {
		...
		dN(up, ConvivaContentInfo, "o1", b0);
		dN(up, ConvivaContentInfo, "clone", b0);
		...
		OZ(up, "obv", Ep9);
		OZ(up, "printContentInfo", Ep9);

		function Ep9(Bl) {
			ct.qF("ConvivaContentInfo[" + Bl + "]", "user input=" + up.c_());
		}
		OZ(up, "XUT", rxV);
		OZ(up, "checkValidity", rxV);
		...
		function rxV(kZl, IiH, V7) {
			...
			if (up.lTq != null && !up.U8U.OC(up.lTq)) {
				kZl("deviceType is not one of the recognized device types enumerated in ConvivaContentInfo.", "Actual value: " + up.lTq + " .");
			}
			if (V7) {
				if (up.hTs != null) {
					...
					if (up._fK != null && !up.BYE.OC(up._fK)) {
						kZl("cdnName is not one of the recognized CDN names enumerated in ConvivaContentInfo.", "Actual value: " + up._fK + " .");
					}
	...
	function ConvivaStreamerProxy() {
		...
		OZ(up, "nHx", hNf);
		OZ(up, "GetStartingBufferLengthMs", hNf);

		function hNf() {
			return -1;
		}
		OZ(up, "YU7", LGW);
		OZ(up, "SetStartingBufferLengthMs", LGW);
		...
		OZ(up, "JIr", RWb);
		OZ(up, "GetCpuPercent", RWb);

		function RWb() {
			return -1.0;
		}
		OZ(up, "ilA", b46);
		OZ(up, "GetMemoryAvailable", b46);
		...
		OZ(up, "SNS", CDf);
		OZ(up, "GetStreamerVersion", CDf);

		function CDf() {
			return -1;
		}
		OZ(up, "hv7", taf);
		OZ(up, "FetchCandidateStreams", taf);
		...
		OZ(up, "FGc", UP);
		OZ(up, "SetMonitoringNotifier", UP);
		...
		OZ(up, "FkN", puP);
		OZ(up, "GetLoadingStatus", puP);

		function puP() {
			return up.fx3;
		}
		OZ(up, "MnZ", luX);
		OZ(up, "GetPlayingState", luX);

		function luX() {
			return up.OjE;
		}
		OZ(up, "Wid", dMh);
		OZ(up, "GetBitrateKbps", dMh);

		function dMh() {
			return up.UQZ.M9;
		}
		OZ(up, "Iom", w71);
		OZ(up, "GetCdnName", w71);

		function w71() {
			return up.UQZ._fK;
		}
		OZ(up, "RhM", D_q);
		OZ(up, "GetResource", D_q);
		...
		OZ(up, "t_t", oJI);
		OZ(up, "GetStreams", oJI);

		function oJI() {
			return null;
		}
		OZ(up, "dcl", TsV);
		OZ(up, "GetLastError", TsV);

		function TsV() {
			return up.sOE;
		}
		OZ(up, "tUW", ACM);
		OZ(up, "GetLastMetadata", ACM);

		function ACM() {
			return up.fDr;
		}
		OZ(up, "br4", STP);
		OZ(up, "GetDisplayWidth", STP);

		function STP() {
			return up.BaK;
		}
		OZ(up, "cMt", hhq);
		OZ(up, "GetDisplayHeight", hhq);
	...
	function StreamInfo() {
		...
		function YQT(jy) {
			...
			return up._fK == jy._fK && up.w6 == jy.w6 && up.M9 == jy.M9 && up.fm == jy.fm && up.mR7 == jy.mR7 && up.vuw == jy.vuw;
		}
		dN(up, StreamInfo, "QKZ", UuP);
		dN(up, StreamInfo, "ConstructClone", UuP);
		...
		function Ua() {
			...
			return "type=" + Fe2 + ", bitrateKbps=" + up.M9 + ", resource=" + (up.w6 != null ? up.w6 : "null") + ", cdnName=" + (up._fK != null ? up._fK : "null") + ", sourceHeightPixels=" + up.mR7 + ", sourceWidthPixels=" + up.vuw;
		}
	...
	function StreamSwitch() {
		...
		dN(up, StreamSwitch, "LII", p_4);
		dN(up, StreamSwitch, "MakeSwitch", p_4);

		function p_4(bWS, wo1, f1) {
			return new StreamSwitch(StreamSwitch.BEz(false), bWS, wo1, -1, null, f1);
		}
		dN(up, StreamSwitch, "QpG", AhB);
		dN(up, StreamSwitch, "MakeSwitchToStream", AhB);
		...
		ED(up, "Pkb", yrY);
		ED(up, "sourceStream", yrY);

		function yrY() {
			return up.w25;
		}
		Wf(up, "Pkb", z_O);
		Wf(up, "sourceStream", z_O);
		...
		ED(up, "lfw", psL);
		ED(up, "targetStream", psL);

		function psL() {
			return up.cH3;
		}
		Wf(up, "lfw", MDi);
		Wf(up, "targetStream", MDi);
		...
		dN(up, StreamSwitch, "QKZ", UuP);
		dN(up, StreamSwitch, "ConstructClone", UuP);

		function UuP(lGX) {
			return lGX;
		}
		dN(up, StreamSwitch, "rL", ry);
		dN(up, StreamSwitch, "StaticInit", ry);

		function ry() {
			StreamSwitch.YF9 = 0;
		}
		dN(up, StreamSwitch, "bx", vl);
		dN(up, StreamSwitch, "StaticCleanup", vl);

		function vl() {
			StreamSwitch.YF9 = 0;
		}
		dN(up, StreamSwitch, "BEz", PYD);
		dN(up, StreamSwitch, "GetNextId", PYD);
	...
	function StreamerError() {
		...
		dN(up, StreamerError, "kHO", Imp);
		dN(up, StreamerError, "makeUnscopedError", Imp);

		function Imp(k3, XfB) {
			return new StreamerError(k3, null, -1, XfB, StreamerError.UQc);
		}
		dN(up, StreamerError, "YKZ", ZRP);
		dN(up, StreamerError, "makeStreamError", ZRP);

		function ZRP(KU, XfB, slO) {
			return new StreamerError(KU, slO, -1, XfB, StreamerError.e9E);
		}
		dN(up, StreamerError, "qM6", ftG);
		dN(up, StreamerError, "makeStreamSegmentError", ftG);
		...
		dN(up, StreamerError, "QKZ", UuP);
		dN(up, StreamerError, "ConstructClone", UuP);
		...
		function Ua() {
			return "errorCode=" + (up.k3 != null ? up.k3 : "null") + ", index=" + up.dHu + ", severity=" + up.XfB + ", scope=" + up.cmo + ", stream=(" + up.slO + ")";
		}
		if (up != fj) ju.apply(up, arguments);
	}
	...
	function UF() {
		...
		function S2(f8) {
			...
			var E0 = null;
			if (f8.hasOwnProperty("UX")) E0 = f8.UX();
			else E0 = f8;
			var _W = "";
	...
	function nD() {
		...
		function Wv3(H1, qA, jm, ym) {
			...
			up.rU = "id=" + up.Eo + ",method=" + up.tM + ",url=" + ID + ",contentType=" + up.ar + "," + jV;
			DX();
		}
		...
		function PjU(rU) {
			rU = rU.replace(X5I, function(match) {
				return (match == b7K ? String.fromCharCode(0) : String.fromCharCode(1));
			});
			return rU;
		}
		...
		function xHs(nI) {
			return nI.replace(TjV, function(match) {
				return (match == String.fromCharCode(0) ? b7K : Cn5);
			});
		}
	...
	function Inferrer() {
		...
		function _iv() {
			...
			if (SZx >= Math.min(up.T8Y, up.ZRS)) {
				...
				qZE /= SZx;
				if (SZx >= up.T8Y && Math.abs(qZE - up.Lnr) < up.qr7) {
					KL4 = Inferrer.MOVING_STATE;
				}
				if (SZx >= up.ZRS && qZE == up.W9b) {
	...
	function CO() {
		...
		function Tm() {
			...
			up.f9 = new nD(H1, function(EU, fh) {
				up.we6(EU, fh);
			}, null, ym);
		}
		LK(up, "we6", DrT);
				...
				if (up.sHG) {
					...
					if (EU == null) {
						...
						if (cR5 == fh.H1) {
							...
							up.Tko = new nD(cR5, function(fe, E7) {
								up.XBL(fe, E7);
							}, null, ym);
						}
					}
		...
		function s4() {
			...
			if (!up.qun(up.lQv)) {
				var rU = "LivePassConfigLoader.HandleNewConfig:" + "Got an invalid livePassConfig ";
				if (O9.rV() < 0.001) {
					rU += ("doc=" + up.lQv.vo());
					rU = oL.n0(rU, 0, 1000);
				}
			...
			if (Ykc) {
				...
				if (osi != 1) {
					var MVp = "LivePassConfigLoader.processConfigXML:" + "Did not find exactly one alternative. alt=" + oL.fg(up.bB) + ", " + "count=" + osi;
					if (O9.rV() < 0.001) {
						MVp += ("doc=" + up.lQv.vo());
		...
		function l5d(p4b) {
			...
			while (p4b > 0 && !fYT) {
				switch (up.KQN) {
				case 0:
					up.ZE = up.Gv("heartbeatIntervalMs", "value", CO.ku);
					up.ZE = up.Gv("heartbeatInterval", "msecs", up.ZE);
					up.dp = up.Gv("heartbeatIntervalLightMs", "value", up.ZE);
					up.wV = up.Gv("heartbeatIntervalUrgentFullMs", "value", CO.WC);
					up.__ = up.Gv("heartbeatIntervalUrgentLightMs", "value", CO.WC);
					up.PQ = up.Gv("heartbeatIntervalPauseMs", "value", up.ZE);
					up.Jy = up.Gv("initSelectResourceIntervalMs", "value", CO.LP);
					up.c2 = up.Gv("selectResourceIntervalMs", "value", CO.ql);
					up.c2 = up.Gv("selectResourceInterval", "msecs", up.c2);
					up.Tl = up.SX("protocolVersion", "value", CO.e3);
					up.Tl = up.SX("protocolVersion", "ver", up.Tl);
					var D0 = up.Gv("refreshIntervalSec", "value", CO.fa);
					D0 = up.Gv("refreshInterval", "secs", D0);
					if (D0 * 1000 != up.lY) {
						up.lY = D0 * 1000;
						if (up.gF != null) {
							up.gF.wy();
					...
					var Vo = up.Gv("maxPlayerPausedIntervalSec", "value", CO.uF);
					Vo = up.Gv("maxPlayerPausedIntervalSec", "secs", Vo);
					CO._B = 1000 * Vo;
					break;
				case 1:
					var SR = up.Gv("maxPlayerBufferingIntervalSec", "value", CO.N0);
					SR = up.Gv("maxPlayerBufferingIntervalSec", "secs", SR);
					CO.Wh = 1000 * SR;
					var iE = up.Gv("maxPlayerStoppedIntervalSec", "value", CO.zS);
					iE = up.Gv("maxPlayerStoppedIntervalSec", "secs", iE);
					CO.OU = 1000 * iE;
					var tS1 = up.Gv("minStartStopIntervalMs", "value", CO.Ou_);
					CO.WVf = tS1;
					var AZ9 = up.Gv("phtStopThresholdSec", "value", CO.cgp);
					CO.ukx = AZ9;
					var Yxn = up.Gv("urlGeneratorTimeoutSec", "value", CO.Fn5);
					CO.nup = Yxn;
					var gTJ = up.Gv("traceOnSwitchDurationThresholdSec", "value", CO.S4t);
					CO.B33 = gTJ;
				...
				case 3:
					...
					var lnq = (up.Gv("flashAccessPingPct", "value", CO.h4A));
					CO.kxN = lnq / 100.0;
					var yz = up.Gv("maxPlayerErrorIntervalSec", "value", CO.vg);
					yz = up.Gv("maxPlayerErrorIntervalSec", "secs", yz);
					CO.HQ = 1000 * yz;
					CO.zHg = up.SX("abName", "value", CO.Kox);
					var Ym9 = up.Gv("bandwidthMbrSafetyPct", "value", CO.K84);
					CO.Qpn = Ym9 / 100.0;
					CO.eKR = (up.SX("flashAccessModuleDownloadEnabled", "value", "true") == "true");
					CO.GAq = (up.SX("fakeBufferFullEnabled", "value", "true") == "true");
					var yF = up.Gv("maxPlayerNotMonitoredIntervalSec", "value", CO.Mu);
					yF = up.Gv("maxPlayerNotMonitoredIntervalSec", "secs", yF);
					CO.mz = 1000 * yF;
					CO.OQ = up.Gv("maxLiveControlBufferEvent", "value", CO.rH);
					CO.D2 = up.lHg("maxLiveControlDurationSec", "value", CO.Oi);
					CO.xb = up.lHg("maxLiveControlBufferingTimeSec", "value", CO.qz0);
					CO.ur = up.lHg("maxLiveControlInitBufferingTimeSec", "value", CO.NYf);
					break;
				case 4:
					CO.CPP = up.lHg("maxVodControlBufferingTimeSec", "value", CO.eD8);
					CO.MOY = up.lHg("maxVodControlInitBufferingTimeSec", "value", CO.F5Q);
					CO.YrT = up.lHg("maxZeriControlBufferingTimeSec", "value", CO.Z1d);
					CO.MW = up.Gv("liveBufferTimeSec", "value", CO.ao);
					CO.nP = 1000 * up.Gv("bwUpdateIntervalSec", "value", CO.qS);
					CO.P5 = 1000 * up.Gv("tokenExpiredIntervalSec", "value", CO.CH);
					CO.dj = (up.SX("connectionRacerMemoryEnabled", "value", "false") == "true");
					CO.tz = up.Gv("ConfigLoadIgnoreSec", "value", CO.o7);
					CO.uI = up.Gv("frameDropRatioThreshold", "value", CO.rA);
					up.dB = up.Gv("joinHbDelayMs", "value", CO.gk);
					...
					CO.r0D = up.Gv("maxRepeatedEventAgeMs", "value", CO.M76);
					CO._PF = up.Gv("maxRepeatedEventsPerSessInfo", "value", CO.UUz);
					CO.Eii = up.Gv("fcSubscribeTryTimes", "value", CO.BPn);
					CO.AKr = up.SX("fcSubscribeUrlRegex", "value", CO.IhZ);
					CO.JLS = up.UZr("inferPlayingStateFromFramerate", "value", CO.xXe);
					CO.wuk = up.UZr("netStreamInfoEnabled", "value", CO.you);
					CO.CVM = up.UZr("convivaBwMeasurementEnabled", "value", CO.Nbp);
					CO.QPE = up.Gv("chunkRecoveryCheckIntervalSec", "value", CO.avT);
					CO.ti_ = up.UZr("disableFullChunkReport", "value", CO.DNM);
					CO.GOJ = up.UZr("isCachedChunkCountedForBwMeasurement", "value", CO.LbH);
					CO.Gc2 = up.Gv("chunkRecoveryBufferLengthProvisionPercent", "value", CO.GfX);
		...
		function Dwz(sz, n1, XP8, Tcp) {
			...
			for (var co = 0; co < 100; co++) {
				hC += "\t\t\t<gateway protocolVersision='0' loadState='available'>" + rk + "gw" + CO.fUC(oL.fg(co), 3) + ".lphbs.com</gateway>\n";
			}
			CO.LUW = "<livePassConfig isFakeConfig='true'>\n\
                              \t<common>\n\
                              \t\t<gateways>\n" + hC + "</gateways>\n" + "\t\t<modulePath>" + kYz + "</modulePath>\n" + "\t\t<silverModulePath>" + kf6 + "</silverModulePath>\n" + "\t\t<jsModulePath>" + zWA + "</jsModulePath>" + "\t</common>\n\
                             </livePassConfig>";
		}
		dN(up, CO, "Ykc", Upo);
	...
	function UU() {
		...
		UU.FD = function() {
			...
			var Vp = [];
			for (var G2 in UU.zB) {
				if (UU.zB.hasOwnProperty(G2)) Vp.push(G2);
			}
			return oL.js(Vp);
		};
	...
	function SH() {
		...
		function dG() {
			...
			if (SH.LZ.Bt > 0) {
				...
				SH.cV = new nD(SH.Bo + "&" + rU, function(EU, fh) {
					if (EU != null) {
	...
	function ct() {
		...
		ct.qF = function(yM, rU) {
			...
			rU = Lr5() + rU;
			if (nAt() && window.console && window.console.log) window.console.log(rU);
			a7(rU);
		};
		ct.M3x = function(yM, rU) {
			rU = Lr5() + yM + ": " + rU;
			if (nAt() && window.console && window.console.warn) window.console.warn(rU);
			a7(rU);
		};
		ct.Error = function(yM, rU) {
			rU = Lr5() + yM + ": " + rU;
			if (nAt() && window.console && window.console.error) window.console.error(rU);
			a7(rU);
		};
		ct.EM = function() {};
		ct.Eoy = function() {
	...
	function WP() {
		...
		function kP(sz, TY, T0) {
			WP.X7 = TY;
			var Hls = false;
			var RcP = (WP.r9.Wt("disablePersistentStorage") ? Boolean(WP.r9.tc("disablePersistentStorage")) : false);
			UU.nr(RcP, function() {
				Hls = true;
			});
			...
			StreamSwitch.rL();
			WP.yLO = false;
			WP.Tg = new Lt(WP.f9.Yo, function() {
				WP.h1(true, true);
			}, "Control.HB");
			WP.hr = new aA(WP.f9);
			WP.mU = "";
		...
		function cmD(oG) {
			...
			ct.qF("Control", "Send message to gateway with " + oG.ug + " sessions, " + qLc + " custom, and " + w3 + " select resource");
			WP.f_B(rU);
			var jm = WP.jI8(rU);
			WP.hr.z2(WP.f9.PH + "/lpg/msg", jm, WP.Db, WP.ua);
		}
		dN(up, WP, "jI8", Pz3);
		...
		function yZ() {
			if (WP.r9 != null && WP.r9.Wt("loaderVersionMajor") && WP.r9.Wt("loaderVersionMinor") && WP.r9.Wt("loaderVersionRelease")) {
				var hK = new WE();
				try {
		...
		function fX(zU, yU, kg) {
			...
			if (ek > zU || (ek == zU && (Ge > yU || (Ge == yU && cH >= kg)))) {
				return true;
			}
			return false;
		}
	...
	function aA() {
		...
		function lZ(Oh, jV, mf, Yi) {
			...
			var hj = function() {
					...
					if (up.I7.OC(AG) && AG.YU() == 0) {
						AG.wy();
						up.I7.gS(AG);
					}
				};
			up.zv.z2(Oh, jV, function(KA, PHc) {
				hj();
				if (AG == up.zv) {
					up.n9D.Yb(PHc);
					up.S1 = 0;
	...
	function _U() {
		...
		function ju(KC) {
			...
			up.Gh.jz = new VI();
			if (up.hA.Wt(_U.P_) && (up.hA.tc(_U.P_) != null) && (up.hA.tc(_U.P_) != "")) {
				ct.qF("GenericSession", "CNO: Changing assetName from \"" + up.Ay.CXF + "\" to \"" + up.hA.tc(_U.P_) + "\"");
	...
	function Og() {
		...
		function lZ(Oh, jV, mf, Yi) {
			...
			var iCN = undefined;
			if (Og.xT0 == null) {
				iCN = new nD(up.N2 + "/" + Oh, qA, jV, pv);
			} else {
				iCN = Og.xT0(Oh, qA, jV, pv);
			}
			up.t5.Yb(iCN);
		}
		OZ(up, "YU", gI);
	...
	function tZ() {
		...
		function LE(YM) {
			var b58 = (up.Ay.fi && (up.Ay.Sc == null || up.Ay.Sc.Bt == 0));
			if (b58) {
				up.Li(ConvivaNotification.rg, "MediaSession: candidateResources must be set");
				return;
			}
			up.uB.NK(YM);
		}
		...
		function tr() {
			return ((up.aN == null || up.aN.ca == Ux.nw) ? 0 : up.aN.dD());
		}
		ED(up, "R2", g1);
		...
		function XeK(sr) {
			for (var co = 0; co < up.uB.Ngz.ug; co++) {
				if (sr == up.uB.Ngz.tc(co).w6.T3()) return up.uB.Ngz.tc(co).rZ;
			}
			return GY.JRP;
		}
		OZ(up, "KwN", hWI);
		...
		function oZ(_D, EoN) {
			...
			if (up.sY == _U.ki) {
				var Lg = CO.el().W1;
				if (Lg != CO.el().Yo && up.Pq != 0 && hR.SI(up.Pq, na) < Lg - 200) {
		...
		function O5h() {
			var nW1 = function(rU, gp) {
					O9.Ep("Fatal: " + rU + (gp != null ? " IGNORE " + gp : ""), true);
					ct.Error("Ms[" + up.Bl + "]", rU + (gp != null ? " (" + gp + ")" : "") + "  Due to this fatal error, the session must be destroyed.");
					WP.Li(new ConvivaNotification(ConvivaNotification.rg, rU + (gp != null ? " (" + gp + ")" : ""), up.CXF));
					up.AGP();
				};
			var Vuc = function(rU, gp) {
					ct.M3x("Ms[" + up.Bl + "]", rU + (gp != null ? " (" + gp + ")" : ""));
				};
	...
	function mv() {
		...
		function ju(wi, Iyv) {
			...
			up.QCo = 0;
			up.lU = -1;
			up.fI = new FQ(n4.z_(mv.Ud), n4.z_(mv.Ud / 20));
			up.Hm = null;
			up.Y0 = new jh(0);
			up.ta = new Yw();
			if (up.CI != null) {
		...
		function uN(y_, Zp) {
			var PE = -1;
			if (y_.Nm >= 0) {
				if (up.Hm == null && y_.Nm < up.QCo) {
					ct.qF("R[" + up.CI.Bl + "]", "Received a stale response with status code " + y_.AR + " and warning code " + y_.oI + " with " + y_.f5XG() + " resources");
					return;
				}
				up.lU = y_.Nm;
				up.FH = y_.Wuxz();
	...
	function PT() {
		...
		function YMe(_w, jz) {
			var KC = new ConvivaContentInfo(jz, oL.R5(new Yw()), new EW());
			var _D = new fS(KC);
			PT.dLI.a9(VW.z_(_D.Jl), _D);
			PT.yep.a9(_w, _D);
			return _D;
	...
	yR(h3, "h3");
	Ip.B6(h3, "Kx" + ",u2", "on" + ",u1", "ic" + ",u2", "Mb" + ",i1", "Oa" + ",i8", "pW" + ",a=c=" + "T_" + "", "sh" + ",b,e", "Yf" + ",a=u4:" + "P0" + "(),e,c=" + "r2" + "()", "TK" + ",u4,e", "ST" + ",u1,e", "Cji" + ",b,e,o=" + "ST" + ":0", "wrD" + ",i4,e,o=" + "ST" + ":1,c=" + "nUD" + "()");

	function xD() {
		Ip.Kt(this, true, xD);
	};
	yR(xD, "xD");
	Ip.B6(xD, "Kx" + ",u2", "on" + ",u1", "ic" + ",u2", "rv" + ",c=" + "CM" + "", "Ei" + ",a=c=" + "pA" + "", "gq" + ",c=" + "Ku" + "");

	function aj() {
		Ip.Kt(this, false, aj);
	};
	yR(aj, "aj");
	Ip.B6(aj, "on" + ",u1", "ic" + ",u2", "M9" + ",u2", "WR" + ",i4,d=-1", "B0" + ",i4,d=-1,e", "ST" + ",u1,e", "qt" + ",i4,d=-1,e,o=" + "ST" + ":0");

	function WE() {
		Ip.Kt(this, false, WE);
	};
	yR(WE, "WE");
	Ip.B6(WE, "on" + ",u1", "ic" + ",u2", "uv" + ",u1", "wG" + ",u1", "VY" + ",u1");

	function Er() {
		Ip.Kt(this, false, Er);
	};
	yR(Er, "Er");
	Ip.B6(Er, "on" + ",u1", "ic" + ",u2");
	Er.XC = 0;
	Er.CE = 4;
	Er.UR = 5;
	Er.bFr = 6;
	...
	yR(qV, "qV");
	Ip.B6(qV, "on" + ",u1", "ic" + ",u2", "X2" + ",i8", "fD" + ",s");

	function OA() {
		Ip.Kt(this, false, OA);
	};
	yR(OA, "OA");
	Ip.B6(OA, "on" + ",u1", "ic" + ",u2", "w6" + ",s", "rZ" + ",i4", "yT" + ",b");
	...
	yR(hs, "hs");
	Ip.B6(hs, "on" + ",u1", "ic" + ",u2", "Sj" + ",s", "X2" + ",i8", "KD" + ",b", "OE" + ",i4,c=" + "OI" + "()", "Nm" + ",i4", "cO" + ",i4", "Ml" + ",m", "kB" + ",m", "PV" + ",m");

	function RO() {
		Ip.Kt(this, false, RO);
	};
	yR(RO, "RO");
	Ip.B6(RO, "on" + ",u1", "ic" + ",u2", "uZ" + ",i4", "PZ" + ",i4");

	function tS() {
		Ip.Kt(this, false, tS);
	};
	yR(tS, "tS");
	Ip.B6(tS, "on" + ",u1", "ic" + ",u2", "PE" + ",i4", "uZ" + ",i4", "PZ" + ",i4");

	function WY() {
		Ip.Kt(this, false, WY);
	};
	yR(WY, "WY");
	Ip.B6(WY, "on" + ",u1", "ic" + ",u2");
	WY.Jn = 0;
	WY.cB = 1;
	...
	yR(ud, "ud");
	Ip.B6(ud, "on" + ",u1", "ic" + ",u2", "n9" + ",i8", "OE" + ",i8");

	function GH() {
		Ip.Kt(this, false, GH);
	};
	yR(GH, "GH");
	Ip.B6(GH, "on" + ",u1", "ic" + ",u2", "w6" + ",c=" + "Oy" + "");

	function xm() {
		Ip.Kt(this, false, xm);
	};
	yR(xm, "xm");
	Ip.B6(xm, "on" + ",u1", "ic" + ",u2", "qx" + ",i4", "A3" + ",i4", "k4" + ",a=c=" + "AO" + "");

	function yj() {
		Ip.Kt(this, false, yj);
	};
	yR(yj, "yj");
	Ip.B6(yj, "on" + ",u1", "ic" + ",u2", "Gj" + ",b", "JZ" + ",i4", "dQ" + ",c=" + "Oy" + "", "hA" + ",s", "jz" + ",s", "cX" + ",i4,d=-1", "Ai" + ",i4", "kY" + ",i2,d=-1", "OV" + ",c=" + "Oy" + ",e", "ZT" + ",i2,d=0,e", "ST" + ",u1,e", "TMi" + ",i4,d=0,e,o=" + "ST" + ":0", "oP9" + ",i1,e,o=" + "ST" + ":1", "Kjn" + ",i8,d=0,e,o=" + "ST" + ":2");
	...
	yR(jb, "jb");
	Ip.B6(jb, "on" + ",u1", "ic" + ",u2", "IH" + ",c=" + "ud" + "", "Sj" + ",s", "t4" + ",m", "ir" + ",b", "nQ" + ",d,c=" + "XP" + "()");

	function Ku() {
		Ip.Kt(this, false, Ku);
	};
	yR(Ku, "Ku");
	Ip.B6(Ku, "on" + ",u1", "ic" + ",u2", "Mb" + ",i1", "SC" + ",a=c=" + "qV" + "");

	function RV() {
		Ip.Kt(this, false, RV);
	};
	yR(RV, "RV");
	Ip.B6(RV, "on" + ",u1", "ic" + ",u2", "Nm" + ",i4", "AR" + ",i1");

	function PL() {
		Ip.Kt(this, false, PL);
	};
	yR(PL, "PL");
	Ip.B6(PL, "on" + ",u1", "ic" + ",u2", "w6" + ",c=" + "Oy" + "", "ws" + ",i4", "Xt" + ",i8", "Jc" + ",i2,d=-1,e", "V4" + ",a=c=" + "RJ" + ",e", "Gi" + ",i2,d=-1,e", "WR" + ",i4,d=-1,e", "iO" + ",i4,d=-1,e", "B0" + ",i4,d=-1,e");
	...
	yR(j7, "j7");
	Ip.B6(j7, "on" + ",u1", "ic" + ",u2", "Nm" + ",i4", "AR" + ",i1", "oI" + ",i4", "f5" + ",a=c=" + "OA" + "", "Wu" + ",a=u1,e", "aZ" + ",b,e", "pk" + ",c=" + "tS" + ",e,c=" + "Md" + "()", "ST" + ",u1,e", "Dgv" + ",c=" + "tNj" + ",e,o=" + "ST" + ":0");
	...
	yR(CM, "CM");
	Ip.B6(CM, "on" + ",u1", "ic" + ",u2", "ib" + ",a=u4:" + "xW" + "()", "Cn" + ",c=" + "WE" + "", "TY" + ",c=" + "Oy" + "", "Xy" + ",c=" + "xm" + ",e", "M0" + ",u4,e", "ST" + ",u1,e", "Xj" + ",u2,d=0,e,o=" + "ST" + ":0", "QyN" + ",u4,e,o=" + "ST" + ":1", "AXQ" + ",i4,e,o=" + "ST" + ":2", "rME" + ",a=i4,e,o=" + "ST" + ":3");

	function Zq() {
		Ip.Kt(this, false, Zq);
	};
	yR(Zq, "Zq");
	Ip.B6(Zq, "on" + ",u1", "ic" + ",u2", "Nm" + ",i4", "IH" + ",c=" + "ud" + "", "eY" + ",m", "EG" + ",a=c=" + "jb" + "");

	function oR() {
		Ip.Kt(this, false, oR);
	};
	yR(oR, "oR");
	Ip.B6(oR, "on" + ",u1", "ic" + ",u2", "Nm" + ",i4", "dv" + ",i4,d=-1", "EA" + ",i4,d=-1", "vG" + ",i4,d=-1", "IC" + ",i2,d=-1", "sb" + ",i2,d=-1", "jD" + ",i2,d=-1", "au" + ",i4", "zg" + ",i4", "zc" + ",i4", "Ky" + ",i4", "_f" + ",i4,d=-1", "ps" + ",i4,d=-1", "fF" + ",i1", "uX" + ",a=c=" + "PL" + "", "LI" + ",i4", "rp" + ",i4", "lw" + ",i4,d=-1,e", "w0" + ",i4,d=-1,e", "LM" + ",i4,d=-1,e", "oF" + ",i4,e", "Gu" + ",i1,e", "_7" + ",a=c=" + "aj" + ",e", "ZL" + ",i4,d=0,e", "E8" + ",i4,e", "vi" + ",i2,d=-1,e", "Q5" + ",i4,d=-16777220,e");
	oR.oH = -16777220;
	oR.gt = -16777219;
	...
	yR(Ym, "Ym");
	Ip.B6(Ym, "on" + ",u1", "ic" + ",u2", "Nm" + ",i4", "RI" + ",a=s", "yv" + ",i2,d=-1", "Bc" + ",a=c=" + "GH" + ",e", "Dj" + ",a=c=" + "ky" + ",e", "JN" + ",a=u1,e", "aZ" + ",b,e", "pk" + ",c=" + "RO" + ",e,c=" + "Md" + "()", "p9" + ",b,e", "Ky" + ",i4,e", "ST" + ",u1,e", "UcG" + ",c=" + "tNj" + ",e,o=" + "ST" + ":0", "ywE" + ",s,e,o=" + "ST" + ":1");
	...
	yR(T_, "T_");
	Ip.B6(T_, "on" + ",u1", "ic" + ",u2", "JZ" + ",i4", "h4" + ",b", "Zk" + ",c=" + "j7" + ",c=" + "Lw" + "()", "gj" + ",b", "lp" + ",c=" + "RV" + ",c=" + "CT" + "()", "ST" + ",u1,e", "Bum" + ",b,e,o=" + "ST" + ":0", "dZc" + ",c=" + "mGV" + ",e,o=" + "ST" + ":1,c=" + "r_4" + "()");
	...
	yR(QR, "QR");
	Ip.B6(QR, "on" + ",u1", "ic" + ",u2", "j_" + ",i1", "GD" + ",i8", "e6" + ",a=c=" + "Zq" + "", "oe" + ",i4,e", "O4" + ",b,e", "yA" + ",a=c=" + "hs" + ",e,c=" + "qa" + "()", "ST" + ",u1,e", "YH2" + ",a=c=" + "sYs" + ",e,o=" + "ST" + ":0");
	...
	yR(pA, "pA");
	Ip.B6(pA, "on" + ",u1", "ic" + ",u2", "KC" + ",c=" + "yj" + "", "y4" + ",b", "eN" + ",c=" + "Ym" + ",c=" + "eC" + "()", "ZN" + ",b", "HX" + ",c=" + "oR" + ",c=" + "EB" + "()", "z9" + ",b,e", "X_" + ",c=" + "QR" + ",e,c=" + "Fh" + "()", "ST" + ",u1,e", "_L4" + ",a=c=" + "a_Y" + ",e,o=" + "ST" + ":0");

	function _g7() {
		Ip.Kt(this, false, _g7);
	};
	yR(_g7, "_g7");
	Ip.B6(_g7, "on" + ",u1", "ic" + ",u2");
	_g7.EQT = 0;
	_g7.ibQ = 1;
	_g7.NqQ = 2;
	...
	yR(mer, "mer");
	Ip.B6(mer, "on" + ",u1", "ic" + ",u2", "ST" + ",u1", "w6" + ",s,o=" + "ST" + ":0", "n1E" + ",a=i4");

	function WT0() {
		Ip.Kt(this, false, WT0);
	};
	yR(WT0, "WT0");
	Ip.B6(WT0, "on" + ",u1", "ic" + ",u2");
	WT0.Lnh = 0;
	WT0.I6 = 1;
	WT0.hO = 2;
	WT0.BS = 3;
	...
	yR(a_Y, "a_Y");
	Ip.B6(a_Y, "on" + ",u1", "ic" + ",u2", "GsS" + ",s", "ST" + ",u1", "FYj" + ",a=s,o=" + "ST" + ":0");

	function EOD() {
		Ip.Kt(this, false, EOD);
	};
	yR(EOD, "EOD");
	Ip.B6(EOD, "on" + ",u1", "ic" + ",u2", "ST" + ",u1", "w6" + ",s,o=" + "ST" + ":0", "M9" + ",i4,o=" + "ST" + ":1");

	function M24() {
		Ip.Kt(this, false, M24);
	};
	yR(M24, "M24");
	Ip.B6(M24, "on" + ",u1", "ic" + ",u2");
	M24.Lnh = 0;
	M24.vn5 = 1;
	M24.nrH = 2;
	...
	yR(lJG, "lJG");
	Ip.B6(lJG, "on" + ",u1", "ic" + ",u2", "ST" + ",u1", "QW8" + ",i4,o=" + "ST" + ":0", "Bg8" + ",i4,o=" + "ST" + ":1");

	function hl1() {
		Ip.Kt(this, false, hl1);
	};
	yR(hl1, "hl1");
	Ip.B6(hl1, "on" + ",u1", "ic" + ",u2", "Ky" + ",i4", "vG" + ",i4", "M_6" + ",i4", "qt" + ",i2", "ST" + ",u1,e", "bJq" + ",i4,e,o=" + "ST" + ":0");

	function qkH() {
		Ip.Kt(this, false, qkH);
	};
	yR(qkH, "qkH");
	Ip.B6(qkH, "on" + ",u1", "ic" + ",u2", "CaI" + ",i4", "rvS" + ",i2");

	function nHd() {
		Ip.Kt(this, false, nHd);
	};
	yR(nHd, "nHd");
	Ip.B6(nHd, "on" + ",u1", "ic" + ",u2", "CaI" + ",i4", "rvS" + ",i4");

	function RJ() {
		Ip.Kt(this, false, RJ);
	};
	yR(RJ, "RJ");
	Ip.B6(RJ, "on" + ",u1", "ic" + ",u2", "k3" + ",i1", "Mf" + ",i2", "ST" + ",u1,e", "QxR" + ",s,e,o=" + "ST" + ":0");
	RJ.Sz = 0;
	RJ.PP = 1;
	RJ.GG = 2;
	RJ.Il = 3;
	...
	yR(dM7, "dM7");
	Ip.B6(dM7, "on" + ",u1", "ic" + ",u2", "RED" + ",s", "H1" + ",s");

	function AFS() {
		Ip.Kt(this, false, AFS);
	};
	yR(AFS, "AFS");
	Ip.B6(AFS, "on" + ",u1", "ic" + ",u2", "ST" + ",u1", "w6" + ",s,o=" + "ST" + ":0", "Q5" + ",i4,o=" + "ST" + ":1", "WHm" + ",i4,o=" + "ST" + ":2");

	function k8L() {
		Ip.Kt(this, false, k8L);
	};
	yR(k8L, "k8L");
	Ip.B6(k8L, "on" + ",u1", "ic" + ",u2", "Sj" + ",s", "ST" + ",u1", "Ml" + ",m,o=" + "ST" + ":0", "kB" + ",m,o=" + "ST" + ":1", "PV" + ",m,o=" + "ST" + ":2");

	function Q6O() {
		Ip.Kt(this, false, Q6O);
	};
	yR(Q6O, "Q6O");
	Ip.B6(Q6O, "on" + ",u1", "ic" + ",u2");
	Q6O.tsU = 0;
	Q6O.XrR = 1;
	Q6O.nl6 = 2;
	...
	yR(dVm, "dVm");
	Ip.B6(dVm, "on" + ",u1", "ic" + ",u2", "ST" + ",u1", "w6" + ",s,o=" + "ST" + ":0", "zg" + ",i4,d=-1,e,o=" + "ST" + ":1");

	function srQ() {
		Ip.Kt(this, false, srQ);
	};
	yR(srQ, "srQ");
	Ip.B6(srQ, "on" + ",u1", "ic" + ",u2");
	srQ.Lnh = 0;
	srQ.JGS = 1;
	srQ.XGF = 2;
	srQ.c9Y = 3;
	...
	yR(sXh, "sXh");
	Ip.B6(sXh, "on" + ",u1", "ic" + ",u2", "ST" + ",u1", "w6" + ",s,o=" + "ST" + ":0", "Xt" + ",i4,d=-1,o=" + "ST" + ":1");

	function AO() {
		Ip.Kt(this, false, AO);
	};
	yR(AO, "AO");
	Ip.B6(AO, "on" + ",u1", "ic" + ",u2", "W0" + ",i4");

	function sqT() {
		Ip.Kt(this, false, sqT);
	};
	yR(sqT, "sqT");
	Ip.B6(sqT, "on" + ",u1", "ic" + ",u2", "ST" + ",u1", "R7p" + ",i4,o=" + "ST" + ":0", "fWb" + ",i4,o=" + "ST" + ":1", "BZA" + ",i4,o=" + "ST" + ":2", "fK" + ",i4,o=" + "ST" + ":3", "yTl" + ",i4,o=" + "ST" + ":4", "gAc" + ",i4,o=" + "ST" + ":5", "ifs" + ",i4,o=" + "ST" + ":6");

	function ot() {
		Ip.Kt(this, false, ot);
	};
	yR(ot, "ot");
	Ip.B6(ot, "on" + ",u1", "ic" + ",u2");
	ot.oQ = "bufTime";
	ot.oM = "connTime";
	ot.oDW = "fBtRcvd";
	ot.Fz = "c3.apiErr";
	...
	yR(tNj, "tNj");
	Ip.B6(tNj, "on" + ",u1", "ic" + ",u2", "Dkh" + ",i4", "tQf" + ",i4", "mSS" + ",i4", "pKR" + ",i4", "ST" + ",u1", "pHE" + ",s,o=" + "ST" + ":0");

	function VpD() {
		Ip.Kt(this, false, VpD);
	};
	yR(VpD, "VpD");
	Ip.B6(VpD, "on" + ",u1", "ic" + ",u2");
	VpD.dTi = 0;
	...
	yR(wdT, "wdT");
	Ip.B6(wdT, "on" + ",u1", "ic" + ",u2", "ST" + ",u1", "h7b" + ",i4,o=" + "ST" + ":0", "w6" + ",s,o=" + "ST" + ":1", "ouW" + ",u2,o=" + "ST" + ":2");
	...
	yR(Oy, "Oy");
	Ip.B6(Oy, "on" + ",u1", "ic" + ",u2", "wf" + ",b", "C6" + ",s,c=" + "RR" + "()", "kn" + ",i4,c=" + "bw" + "()");

	function UN() {
		Ip.Kt(this, false, UN);
	};
	yR(UN, "UN");
	Ip.B6(UN, "on" + ",u1", "ic" + ",u2", "D6" + ",i2", "e2" + ",i2", "xx" + ",i2", "cD" + ",i2", "a_" + ",i1", "fP" + ",i1");
	UN.FSb = 0;
	UN.X6 = 1;
	UN._c = 2;
	UN.aR = 3;
	...
	yR(Mcb, "Mcb");
	Ip.B6(Mcb, "on" + ",u1", "ic" + ",u2", "ST" + ",u1", "ouW" + ",u2,o=" + "ST" + ":0", "n_B" + ",i4,o=" + "ST" + ":1", "dxR" + ",s,o=" + "ST" + ":2");

	function ICp() {
		Ip.Kt(this, false, ICp);
	};
	yR(ICp, "ICp");
	Ip.B6(ICp, "on" + ",u1", "ic" + ",u2", "ST" + ",u1,e", "fm" + ",i1,e,o=" + "ST" + ":0", "eY" + ",i1,e,o=" + "ST" + ":1");

	function Ptl() {
		Ip.Kt(this, false, Ptl);
	};
	yR(Ptl, "Ptl");
	Ip.B6(Ptl, "on" + ",u1", "ic" + ",u2", "ST" + ",u1", "ca" + ",i1,o=" + "ST" + ":0", "BgX" + ",i4,o=" + "ST" + ":1", "SeK" + ",i4,o=" + "ST" + ":2", "WR" + ",i4,o=" + "ST" + ":3", "UM" + ",i4,o=" + "ST" + ":4", "qsk" + ",i1,e,o=" + "ST" + ":5");

	function njx() {
		Ip.Kt(this, false, njx);
	};
	yR(njx, "njx");
	Ip.B6(njx, "on" + ",u1", "ic" + ",u2", "AIg" + ",i1");

	function BZ3() {
		Ip.Kt(this, false, BZ3);
	};
	yR(BZ3, "BZ3");
	Ip.B6(BZ3, "on" + ",u1", "ic" + ",u2", "w6" + ",c=" + "Oy" + "", "DXb" + ",i4", "t4e" + ",i4", "Dne" + ",i4");

	function FBp() {
		Ip.Kt(this, false, FBp);
	};
	yR(FBp, "FBp");
	Ip.B6(FBp, "on" + ",u1", "ic" + ",u2", "ST" + ",u1,e", "lb" + ",i1,e,o=" + "ST" + ":0", "uZ" + ",i4,e,o=" + "ST" + ":1", "PZ" + ",i4,e,o=" + "ST" + ":2");

	function LfH() {
		Ip.Kt(this, false, LfH);
	};
	yR(LfH, "LfH");
	Ip.B6(LfH, "on" + ",u1", "ic" + ",u2", "Od4" + ",c=" + "RJ" + "", "RED" + ",s", "vZj" + ",b");

	function tL2() {
		Ip.Kt(this, false, tL2);
	};
	yR(tL2, "tL2");
	Ip.B6(tL2, "on" + ",u1", "ic" + ",u2", "ca" + ",i1,d=" + (Ux.ft) + "", "ST" + ",u1", "zg" + ",i4,o=" + "ST" + ":0", "zc" + ",i4,o=" + "ST" + ":1", "rp" + ",i4,o=" + "ST" + ":2", "LI" + ",i4,o=" + "ST" + ":3", "M9" + ",i4,o=" + "ST" + ":4", "Z1P" + ",i4,o=" + "ST" + ":5", "jD" + ",i4,o=" + "ST" + ":6", "FVF" + ",i4,o=" + "ST" + ":7", "JEk" + ",u1", "IC" + ",i4,d=-1,o=" + "JEk" + ":0", "dv" + ",i4,o=" + "JEk" + ":1", "HBK" + ",b,o=" + "JEk" + ":2", "y0L" + ",s,o=" + "JEk" + ":3", "_fK" + ",s,o=" + "JEk" + ":4", "xQh" + ",s,o=" + "JEk" + ":5", "w6" + ",s,o=" + "JEk" + ":6", "LZy" + ",i1,e,o=" + "JEk" + ":7", "x8D" + ",u1,e", "Cn" + ",s,e,o=" + "x8D" + ":0", "UlN" + ",i4,e,o=" + "x8D" + ":1", "HRl" + ",m,e,o=" + "x8D" + ":2", "_x_" + ",b,e,o=" + "x8D" + ":3");
	tL2.Fzg = 1;
	tL2.yNw = 1;
	tL2.oLA = 3;
	tL2.Co4 = 4;
	...
	yR(IZV, "IZV");
	Ip.B6(IZV, "on" + ",u1", "ic" + ",u2", "ST" + ",u1", "yvU" + ",i1,o=" + "ST" + ":0", "VW9" + ",i1");

	function YxJ() {
		Ip.Kt(this, false, YxJ);
	};
	yR(YxJ, "YxJ");
	Ip.B6(YxJ, "on" + ",u1", "ic" + ",u2", "ST" + ",u1", "SC7" + ",i1,o=" + "ST" + ":0", "Ngi" + ",b,o=" + "ST" + ":1", "M9" + ",i4,o=" + "ST" + ":2", "w6" + ",s,o=" + "ST" + ":3", "_fK" + ",s,o=" + "ST" + ":4", "CXF" + ",s,o=" + "ST" + ":5", "hA" + ",m,o=" + "ST" + ":6");

	function pXP() {
		Ip.Kt(this, false, pXP);
	};
	yR(pXP, "pXP");
	Ip.B6(pXP, "on" + ",u1", "ic" + ",u2", "ST" + ",u1", "bvs" + ",a=c=" + "nHd" + ",o=" + "ST" + ":0", "j3c" + ",a=c=" + "nHd" + ",o=" + "ST" + ":1", "M4V" + ",a=c=" + "qkH" + ",o=" + "ST" + ":2");

	function sTg() {
		Ip.Kt(this, false, sTg);
	};
	yR(sTg, "sTg");
	Ip.B6(sTg, "on" + ",u1", "ic" + ",u2", "Ti0" + ",i2", "ST" + ",u1", "ouW" + ",u2,o=" + "ST" + ":0");

	function khJ() {
		Ip.Kt(this, false, khJ);
	};
	yR(khJ, "khJ");
	Ip.B6(khJ, "on" + ",u1", "ic" + ",u2", "ST" + ",u1", "Anr" + ",i4,o=" + "ST" + ":0", "Dy9" + ",i1,e,o=" + "ST" + ":1");

	function gdL() {
		Ip.Kt(this, false, gdL);
	};
	yR(gdL, "gdL");
	Ip.B6(gdL, "on" + ",u1", "ic" + ",u2", "ST" + ",u1", "lZd" + ",s,o=" + "ST" + ":0", "H1" + ",s,e,o=" + "ST" + ":1", "oFS" + ",s,e,o=" + "ST" + ":2", "bf0" + ",i1,d=-1,e,o=" + "ST" + ":3", "CF2" + ",i1,e,o=" + "ST" + ":4");

	function xMA() {
		Ip.Kt(this, false, xMA);
	};
	yR(xMA, "xMA");
	Ip.B6(xMA, "on" + ",u1", "ic" + ",u2", "ST" + ",u1", "rT" + ",s,o=" + "ST" + ":0", "LZy" + ",i1", "co2" + ",s,o=" + "ST" + ":1", "QxU" + ",s,o=" + "ST" + ":2", "MNx" + ",i1,o=" + "ST" + ":3", "S03" + ",i1,o=" + "ST" + ":4", "cHG" + ",i1");

	function ysh() {
		Ip.Kt(this, false, ysh);
	};
	yR(ysh, "ysh");
	Ip.B6(ysh, "on" + ",u1", "ic" + ",u2", "ST" + ",u1", "w6" + ",s,o=" + "ST" + ":0", "mRK" + ",a=c=" + "RJ" + ",o=" + "ST" + ":1");

	function vYD() {
		Ip.Kt(this, false, vYD);
	};
	yR(vYD, "vYD");
	Ip.B6(vYD, "on" + ",u1", "ic" + ",u2", "ST" + ",u1", "ca" + ",i1,o=" + "ST" + ":0", "qsk" + ",i1,e,o=" + "ST" + ":1");

	function mGV() {
		Ip.Kt(this, false, mGV);
	};
	yR(mGV, "mGV");
	Ip.B6(mGV, "on" + ",u1", "ic" + ",u2", "JZ" + ",i4", "bHE" + ",i1", "ST" + ",u1", "L97" + ",s,o=" + "ST" + ":0", "BNE" + ",a=c=" + "EOD" + "", "MV8" + ",b,o=" + "ST" + ":1", "wrD" + ",i4,o=" + "ST" + ":2", "tcT" + ",b,o=" + "ST" + ":3");
	mGV.cQb = 0;
	mGV.j0x = 1;
	mGV.Szl = 2;
	mGV.cO0 = 3;
	...
	yR(Eav, "Eav");
	Ip.B6(Eav, "on" + ",u1", "ic" + ",u2", "ST" + ",u1", "w6" + ",s,o=" + "ST" + ":0", "Od4" + ",c=" + "RJ" + "");
	...
	yR(ky, "ky");
	Ip.B6(ky, "on" + ",u1", "ic" + ",u2", "cc" + ",u4", "KG" + ",i4", "FU" + ",i4", "GB" + ",u1", "TQ" + ",i1", "k3" + ",i1", "ge" + ",b,e", "sB" + ",c=" + "UN" + ",e,c=" + "_v" + "()");
	ky.Gg = 1;
	ky.TA = 2;
	ky.N9 = 3;
	ky.I6 = 0;
	...
	yR(yVL, "yVL");
	Ip.B6(yVL, "on" + ",u1", "ic" + ",u2", "ST" + ",u1", "TZX" + ",i1,o=" + "ST" + ":0", "TpH" + ",i4,o=" + "ST" + ":1");

	function ILo() {
		Ip.Kt(this, false, ILo);
	};
	yR(ILo, "ILo");
	Ip.B6(ILo, "on" + ",u1", "ic" + ",u2", "ST" + ",u1", "NR" + ",i1,o=" + "ST" + ":0");

	function AXJ() {
		Ip.Kt(this, false, AXJ);
	};
	yR(AXJ, "AXJ");
	Ip.B6(AXJ, "on" + ",u1", "ic" + ",u2", "ST" + ",u1", "k3" + ",i1,o=" + "ST" + ":0", "Anr" + ",i4,o=" + "ST" + ":1", "oEO" + ",s,o=" + "ST" + ":2", "O3z" + ",c=" + "pXP" + ",o=" + "ST" + ":3", "bmB" + ",i4,e,o=" + "ST" + ":4", "MMC" + ",i4,e,o=" + "ST" + ":5", "qdG" + ",a=c=" + "hl1" + ",e,o=" + "ST" + ":6", "H1" + ",s,e,o=" + "ST" + ":7", "JEk" + ",u1,e", "ouW" + ",u2,e,o=" + "JEk" + ":0");

	function RPD() {
		Ip.Kt(this, false, RPD);
	};
	yR(RPD, "RPD");
	Ip.B6(RPD, "on" + ",u1", "ic" + ",u2", "ST" + ",u1", "MMC" + ",i4,o=" + "ST" + ":0", "dI0" + ",a=c=" + "njx" + ",o=" + "ST" + ":1", "jD" + ",i4,o=" + "ST" + ":2", "O3z" + ",c=" + "pXP" + ",o=" + "ST" + ":3", "bmB" + ",i4,e,o=" + "ST" + ":4", "qdG" + ",a=c=" + "hl1" + ",e,o=" + "ST" + ":5", "ouW" + ",u2,e,o=" + "ST" + ":6", "KdP" + ",i1,e,o=" + "ST" + ":7");

	function FEH() {
		Ip.Kt(this, false, FEH);
	};
	yR(FEH, "FEH");
	Ip.B6(FEH, "on" + ",u1", "ic" + ",u2", "ST" + ",u1", "ca" + ",i1,o=" + "ST" + ":0", "NR" + ",i1,o=" + "ST" + ":1", "lZd" + ",s,o=" + "ST" + ":2", "Anr" + ",i4,o=" + "ST" + ":3", "h7b" + ",i4,o=" + "ST" + ":4", "LZy" + ",i1", "O3z" + ",c=" + "pXP" + ",o=" + "ST" + ":5", "vG" + ",i4,d=-1,o=" + "ST" + ":6", "f_S" + ",i2,d=-1,o=" + "ST" + ":7", "JEk" + ",u1", "k9T" + ",i2,d=-1,o=" + "JEk" + ":0", "dv" + ",i4,d=-1,o=" + "JEk" + ":1", "jD" + ",i2,d=-1,o=" + "JEk" + ":2", "IC" + ",i2,d=-1,o=" + "JEk" + ":3", "sb" + ",i2,d=-1,o=" + "JEk" + ":4", "zg" + ",i4,d=0,o=" + "JEk" + ":5", "zc" + ",i4,d=0,o=" + "JEk" + ":6", "LI" + ",i4,d=-1,o=" + "JEk" + ":7", "x8D" + ",u1", "TU1" + ",i4,d=-1,o=" + "x8D" + ":0", "ap8" + ",i2,d=-1,o=" + "x8D" + ":1", "lz2" + ",i2,d=-1,o=" + "x8D" + ":2", "uY0" + ",i1,o=" + "x8D" + ":3", "zjC" + ",a=c=" + "sXh" + ",o=" + "x8D" + ":4", "_n3" + ",a=c=" + "BZ3" + ",o=" + "x8D" + ":5", "O49" + ",a=c=" + "dVm" + ",e,o=" + "x8D" + ":6", "zir" + ",a=c=" + "ysh" + ",e,o=" + "x8D" + ":7", "vq7" + ",u1,e", "qsk" + ",i1,e,o=" + "vq7" + ":0", "Dy9" + ",i1,e,o=" + "vq7" + ":1", "qdG" + ",a=c=" + "hl1" + ",e,o=" + "vq7" + ":2", "mSS" + ",i4,e,o=" + "vq7" + ":3", "oF" + ",i4,d=-1,e,o=" + "vq7" + ":4", "rp" + ",i4,d=-1,e,o=" + "vq7" + ":5", "y0L" + ",s,e,o=" + "vq7" + ":6", "Gii" + ",i2,d=-1,e,o=" + "vq7" + ":7", "z7b" + ",u1,e", "Z1P" + ",i2,d=-1,e,o=" + "z7b" + ":0", "TvW" + ",c=" + "Mcb" + ",e,o=" + "z7b" + ":1", "XvR" + ",i1,e,o=" + "z7b" + ":2", "oFS" + ",s,e,o=" + "z7b" + ":3", "pKR" + ",i4,e,o=" + "z7b" + ":4");

	function suI() {
		Ip.Kt(this, false, suI);
	};
	yR(suI, "suI");
	Ip.B6(suI, "on" + ",u1", "ic" + ",u2", "ST" + ",u1", "xfe" + ",c=" + "YxJ" + ",o=" + "ST" + ":0", "J34" + ",c=" + "YxJ" + ",o=" + "ST" + ":1");

	function yGM() {
		Ip.Kt(this, false, yGM);
	};
	yR(yGM, "yGM");
	Ip.B6(yGM, "on" + ",u1", "ic" + ",u2", "ST" + ",u1", "hk3" + ",a=c=" + "Eav" + ",o=" + "ST" + ":0");

	function szi() {
		Ip.Kt(this, false, szi);
	};
	yR(szi, "szi");
	Ip.B6(szi, "on" + ",u1", "ic" + ",u2", "ST" + ",u1", "ca" + ",i1,d=" + (Ux.CS) + ",o=" + "ST" + ":0", "dv" + ",i4,o=" + "ST" + ":1", "E8" + ",i4,o=" + "ST" + ":2", "rp" + ",i4,o=" + "ST" + ":3", "LI" + ",i4,o=" + "ST" + ":4", "OJp" + ",i4,o=" + "ST" + ":5", "zir" + ",a=c=" + "ysh" + ",e,o=" + "ST" + ":6", "qsk" + ",i1,e,o=" + "ST" + ":7");

	function lEc() {
		Ip.Kt(this, false, lEc);
	};
	yR(lEc, "lEc");
	Ip.B6(lEc, "on" + ",u1", "ic" + ",u2", "ST" + ",u1", "k3" + ",i1,o=" + "ST" + ":0", "lZd" + ",s,o=" + "ST" + ":1", "D6" + ",i2,o=" + "ST" + ":2", "xx" + ",i2,o=" + "ST" + ":3", "cD" + ",i2,o=" + "ST" + ":4", "oEO" + ",s,o=" + "ST" + ":5", "O3z" + ",c=" + "pXP" + ",o=" + "ST" + ":6", "v6K" + ",i1,e,o=" + "ST" + ":7", "JEk" + ",u1,e", "ZlP" + ",s,e,o=" + "JEk" + ":0", "szo" + ",s,e,o=" + "JEk" + ":1", "qdG" + ",a=c=" + "hl1" + ",e,o=" + "JEk" + ":2", "Anr" + ",i4,e,o=" + "JEk" + ":3", "bmB" + ",i4,e,o=" + "JEk" + ":4", "MMC" + ",i4,e,o=" + "JEk" + ":5", "H1" + ",s,e,o=" + "JEk" + ":6", "ouW" + ",u2,e,o=" + "JEk" + ":7");

	function bOB() {
		Ip.Kt(this, false, bOB);
	};
	yR(bOB, "bOB");
	Ip.B6(bOB, "on" + ",u1", "ic" + ",u2", "ST" + ",u1", "szo" + ",s,o=" + "ST" + ":0", "v6K" + ",i1,o=" + "ST" + ":1", "KdP" + ",i1,o=" + "ST" + ":2", "dI0" + ",a=c=" + "njx" + ",o=" + "ST" + ":3", "O3z" + ",c=" + "pXP" + ",o=" + "ST" + ":4", "ZlP" + ",s,e,o=" + "ST" + ":5", "qdG" + ",a=c=" + "hl1" + ",e,o=" + "ST" + ":6", "bmB" + ",i4,e,o=" + "ST" + ":7", "JEk" + ",u1,e", "MMC" + ",i4,e,o=" + "JEk" + ":0", "ouW" + ",u2,e,o=" + "JEk" + ":1");
	...
	yR(sYs, "sYs");
	Ip.B6(sYs, "on" + ",u1", "ic" + ",u2", "Nm" + ",i4", "cO" + ",i4", "Ky" + ",i4", "iFM" + ",b", "OE" + ",i4,d=-1,c=" + "OI" + "()", "ST" + ",u1", "sWk" + ",m,o=" + "ST" + ":0", "E_B" + ",m,o=" + "ST" + ":1", "zuh" + ",m,o=" + "ST" + ":2", "fm" + ",i1", "KRb" + ",c=" + "k8L" + ",c=" + "DMT" + "()", "EPv" + ",c=" + "FEH" + ",e,c=" + "Nql" + "()", "lvu" + ",c=" + "yGM" + ",e,c=" + "ku5" + "()", "J4I" + ",c=" + "Ptl" + ",e,c=" + "X8m" + "()", "YgT" + ",c=" + "LfH" + ",e,c=" + "Xjb" + "()", "Blh" + ",c=" + "tL2" + ",e,c=" + "WZI" + "()", "aUU" + ",c=" + "lJG" + ",e,c=" + "uPL" + "()", "xij" + ",c=" + "szi" + ",e,c=" + "X7Z" + "()", "x1g" + ",c=" + "vYD" + ",e,c=" + "TDC" + "()", "r_0" + ",c=" + "ILo" + ",e,c=" + "xvB" + "()", "rGb" + ",c=" + "bOB" + ",e,c=" + "VTl" + "()", "Mp1" + ",c=" + "lEc" + ",e,c=" + "kzj" + "()", "AyR" + ",c=" + "RPD" + ",e,c=" + "OyH" + "()", "fJL" + ",c=" + "AXJ" + ",e,c=" + "b2q" + "()", "daO" + ",c=" + "wdT" + ",e,c=" + "E3z" + "()", "fhe" + ",c=" + "yVL" + ",e,c=" + "ikN" + "()", "zh3" + ",c=" + "xMA" + ",e,c=" + "tW6" + "()", "Ams" + ",c=" + "sqT" + ",e,c=" + "zn0" + "()", "Vuh" + ",c=" + "AFS" + ",e,c=" + "U2B" + "()", "mzE" + ",c=" + "gdL" + ",e,c=" + "wLO" + "()", "Iur" + ",c=" + "khJ" + ",e,c=" + "OHi" + "()", "umu" + ",c=" + "sTg" + ",e,c=" + "vE2" + "()", "TU1" + ",i4,d=-1,e,o=" + "ST" + ":3", "bsD" + ",i8,d=0,e,o=" + "ST" + ":4", "jYC" + ",c=" + "ICp" + ",e,c=" + "FtV" + "()", "wSB" + ",c=" + "dM7" + ",e,c=" + "hsy" + "()", "FTv" + ",c=" + "FBp" + ",e,c=" + "PBD" + "()", "_K4" + ",c=" + "mer" + ",e,c=" + "_P8" + "()", "HHX" + ",c=" + "IZV" + ",e,c=" + "EMT" + "()", "nZl" + ",c=" + "suI" + ",e,c=" + "Tks" + "()");
	...
	function aJS() {
		...
		function Qh6() {
			return "BitrateSwitchStartEvent";
		}
		OZ(up, "vo", Ua);
	...
	function jcl() {
		...
		function b13(vw) {
			...
			return "(rs:" + QOR + ", bytes:" + vw.DXb + ", playTime:" + vw.t4e + ", bufTime:" + vw.Dne + ")";
		}
		...
		function zDR() {
			...
			EPv.LZy = up.AdB;
			if (up.ydo >= 0) EPv.f_S = up.ydo;
			if (up.N7I >= 0) EPv.k9T = up.N7I;
			if (up.od >= 0) EPv.jD = up.od;
			if (up.zR >= 0) EPv.IC = up.zR;
			if (up.o4 >= 0) EPv.sb = up.o4;
			if (up.NGs >= 0) EPv.Gii = up.NGs;
			if (up.Ezg >= 0) {
				EPv.dv = up.Ezg;
			}
			if (up.lIz > 0) EPv.vG = up.lIz;
			if (up.ui5 >= 0) EPv.zg = up.ui5;
			if (up.ter >= 0) EPv.zc = up.ter;
			if (up.Kbo > 0) EPv.LI = up.Kbo;
			if (up.LSo > 0) EPv.rp = up.LSo;
			if (up.yOB > 0) EPv.oF = up.yOB;
			if (up.Hy7 > 0) EPv.TU1 = up.Hy7;
			if (up.YR1 > 0) EPv.ap8 = up.YR1;
			if (up.kUy > 0) EPv.lz2 = up.kUy;
			if (up.mog > 0) {
				EPv.Z1P = up.mog;
			}
			EPv.uY0 = up.bvx;
			...
			if (up.sd_ != null && up.sd_.Bt > 0) {
				...
				for (co = 0; co < up.sd_.Bt; co++) {
					EPv.zjCXZ(n4.z_(co), up.sd_.tc(co));
				}
			}
			if (up._Dq != null && up._Dq.Bt > 0) {
				EPv._n3Gw(
				n4.z_(up._Dq.Bt));
				for (co = 0; co < up._Dq.Bt; co++) {
					EPv._n3XZ(n4.z_(co), up._Dq.tc(co));
				}
			}
			if (up.gBw != null && up.gBw.Bt > 0) {
				...
				for (co = 0; co < up.gBw.Bt; co++) {
					EPv.O49XZ(n4.z_(co), up.gBw.tc(co));
				}
			}
			if (up.ZOR != null && up.ZOR.Bt > 0) {
				...
				for (co = 0; co < up.ZOR.Bt; co++) {
					EPv.zirXZ(n4.z_(co), up.ZOR.tc(co));
				}
			}
			if (up.u7Y == EmX.tpF) {
				EPv.qsk = EmX.tpF;
		...
		function Ua() {
			...
			nI = nI + ";integrationType=" + ((up.AdB == X6Z.KFJ) ? "Full" : (up.AdB == X6Z.GZI ? "Light" : "Unknown"));
			if (up.T92 != null) {
			...
			if (up.lIz >= 0) nI = nI + ";bufLen=" + up.lIz;
			if (up.ydo >= 0) nI = nI + ";maxDownloadBw=" + up.ydo;
			if (up.N7I >= 0) nI = nI + ";minDownloadBw=" + up.N7I;
			if (up.Ezg >= 0) nI = nI + ";joinTime=" + up.Ezg;
			if (up.od >= 0) nI = nI + ";encodedFPS=" + up.od;
			if (up.zR >= 0) nI = nI + ";aveFPS=" + up.zR;
			if (up.o4 >= 0) nI = nI + ";playingAvgFPS=" + up.o4;
			if (up.ui5 >= 0) nI = nI + ";totalPlayingTime=" + up.ui5;
			if (up.ter >= 0) nI = nI + ";totalBufferingTime=" + up.ter;
			if (up.Kbo >= 0) nI = nI + ";totalStoppedTime=" + up.Kbo;
			if (up.LSo >= 0) nI = nI + ";totalPausedTime=" + up.LSo;
			if (up.yOB >= 0) nI = nI + ";totalSleepTime=" + up.yOB;
			if (up.Hy7 >= 0) nI = nI + ";lifetimeAvgBr=" + up.Hy7;
			if (up.NGs >= 0) nI = nI + ";lifetimePlayingAverageFps=" + up.NGs;
			if (up.YR1 >= 0) nI = nI + ";totalRsSw=" + up.YR1;
			if (up.kUy >= 0) nI = nI + ";totalRsQuaSw=" + up.kUy;
			if (up.mog >= 0) nI = nI + ";totalBufferingEvents=" + up.mog;
			nI = nI + ";chkpType=" + ((up.bvx == M24.vn5) ? "Periodic" : "GracefulEnd");
			if (up.sd_ != null && up.sd_.Bt > 0) nI = nI + ";" + up.dxy("perRsMeasure", up.sd_, up.bg3);
			if (up._Dq != null && up._Dq.Bt > 0) {
				nI = nI + ";" + up.N3v("chkpForRCC", up._Dq, up.W1S);
			}
			if (up.gBw != null && up.gBw.Bt > 0) {
				nI = nI + ";" + up.Ucs("lifetimeRsMeasure", up.gBw, up.U4m);
			}
			if (up.ZOR != null && up.ZOR.Bt > 0) {
				nI = nI + ";" + up.crf("joinRsMeasure", up.ZOR, up.O7d);
			}
	...
	function ddL() {
		...
		function hmK(izu) {
			return "(rs=" + (izu.yWw6() ? izu.w6.T3() : "current") + ", err=" + izu.Od4.k3 + ", cnt=" + izu.Od4.Mf + ")";
		}
		...
		function Ua() {
			...
			if (up.oGZ != null && up.oGZ.Bt > 0) {
				nI = nI + ";" + up.LWJ("rsErr", up.oGZ, up.Ey9);
			} else {
	...
	function tm8() {
		...
		function vRC(hv) {
			if (hv.fm == srQ.XGF || hv.fm == srQ.c9Y) {
	...
	function fRx() {
		...
		function Qh6() {
			return "IntegrationDetailsEvent";
		}
		OZ(up, "vo", Ua);
		...
		function czK(v9, feP) {
			if (feP == "IntegrationType") {
				...
				if (v9 == X6Z.X0O) return "uninitializedIntegrationType";
			}
			if (feP == "LiveOrVod") {
				if (v9 == X6Z.Jb0) return "live";
				if (v9 == X6Z.D2p) return "vod";
				if (v9 == X6Z.Ad7) return "uninitializedLiveOrVod";
			}
			if (feP == "DemsUsage") {
	...
	function fMf() {
		...
		function Qh6() {
			return "OtherPlayerStateTransitionEvent";
		}
		OZ(up, "vo", Ua);
	...
	function e7H() {
		...
		function Qh6() {
			return "ResourceSwitchStartEvent";
		}
		OZ(up, "vo", Ua);
	...
	function nv() {
		...
		function J07(_j) {
			if (up.Rfi) return;
			up.Zqd = _j;
			if (up.EPZ != null) up.fey(up.EPZ);
			if (up.l7o != null) up.fey(up.l7o);
		}
		OZ(up, "fey", Yrc);
	...
	function _A() {
		...
		function XEr() {
			...
			if (!up.wHf) {
				...
				for (var Jo = 0; Jo < bC.length; Jo++) {
					var hv = bC[Jo];
					ct.qF("SDM[" + up.Pt.Bl + "]", "Repeating unreceived SDM event \"" + hv.gyP() + "\": [" + hv.vo() + "]");
					up.UY(hv);
					v76 = true;
				}
			}
	...
	function s8() {
		...
		function gw7(nzH) {
			up.QSX(nzH);
			up.jEO.Yb(nzH);
			ct.qF("SDM[" + up.Pt.Bl + "]", "Preparing to send SDM event \"" + nzH.gyP() + "\": [" + nzH.vo() + "]");
		}
		LK(up, "QSX", wUf);
	...
	function XiV() {
		...
		function Qh6() {
			return "SessionStateTransitionEvent";
		}
		OZ(up, "vo", Ua);
	...
	function HkZ() {
		...
		function tQs(I8P) {
			return Dh.xI("GetTotalLoadedBytes", I8P) && Dh.xI("SetMonitoringNotifier", I8P);
		}
		dN(up, HkZ, "J1E", Fuv);

		function Fuv(X9e) {
			return Dh.xI("GetTotalLoadedBytes", X9e) && Dh.xI("SetPlayingStateChangeCallback", X9e) && !Dh.xI("Ylo", X9e) && !Dh.xI("SetMonitoringNotifier", X9e);
		}
		dN(up, HkZ, "D4", y6);
	...
	function g6() {
		...
		function RW(eY, R7) {
			...
			for (var co = 0; co < Wp; co++) {
				...
				if (co % 2 == 0) {
					O9.y8(
					up.O5.tc(co).eY == Ux.DV, "state " + co + " should not be " + up.O5.tc(co).eY);
					if (co != 0) {
						UM = nx;
						Nz += UM;
					}
					...
					O9.y8(
					up.O5.tc(co).eY == Ux.CS, "state " + co + " should not be " + up.O5.tc(co).eY);
					UM = 0;
					BM += nx;
				}
			}
	...
	function GY() {
		...
		function E4(G_) {
			...
			up.cg(Ux.cz);
			up.GL = new FQ(GY.wp, GY.wp / 20);
			up.MH = new FQ(GY.wp, GY.wp / 20);
			up.vv = new FQ(GY.CF, GY.CF / 5);
			up.Lr = -1;
			up.KZ = 0;
			var dwB = null;
		...
		function sK(jN0, hlD) {
			...
			for (var Jo = 0; Jo < bC.length; Jo++) {
				...
				if (up.Rf.tc(Tj) != up.V8) sr = up.Rf.tc(Tj).w6;
				var XtA = VW.z_(up.Pfm(up.Rf.tc(Tj), up.VxS));
				var kFA = VW.z_(up.Pfm(up.Rf.tc(Tj), up.hek));
				var Adw = VW.z_(up.Pfm(up.Rf.tc(Tj), up.bnz));
				if (XtA != 0) {
					hlD.z9i(sr, XtA);
					hlD.Ix_(sr, rZ, XtA, kFA, Adw);
				}
		...
		function Id(vw, vV5) {
			...
			var na = Lt.VB();
			var mo = 0.0;
			if (vV5) {} else if (up.UJ == null || up.q8 == Ux.Qh || up.q8 == Ux.cz) {
				var F8 = CO.el().Mi;
				if (up.KZ > 0 && hR.SI(up.KZ, na) < F8 - 200 && up.P3 <= up.KZ) {
		...
		function Aa() {
			...
			if (up.iU == Ez.Le || up.iU == Ez.Io) {
				var Ml = Yw.oIy(Ux.Qh, Ux.DV, Ux.cz, Ux.QG, Ux.nw);
				var tT = Yw.oIy(CO.dy, CO.E6, CO.fN, CO.xn, CO.n_);
				for (var co = 0; co < Ml.Bt; co++) {
					if (up.q8 == Ml.tc(co)) {
						if (hR.SI(up.P3, na) > tT.tc(co)) {
							ct.qF(up.ww, "Suspend current session for time in " + GY.Ak(up.q8) + " > " + tT.tc(co) + "ms");
							up.Xo(Ez.it);
						}
					}
				}
		...
		function SG() {
			...
			var kz = Lt.VB();
			if (up.q8 == Ux.CS || up.q8 == Ux.DV || up.q8 == Ux.Qh) {
				up.BQ(false, false);
			}
			if (up.kws) {
				var R4 = up.Ef();
			...
			up.xK = kz;
			up.gR = oL.fFw(V_);
			if (up.QO.Bt > Math.max(GY._k, GY.eM)) {
				up.QO.DU(up.QO.Bt - 1);
			}
			up.YT1(kz);
		...
		function VBt(kz) {
			...
			if (up.UJ.nj() == "html5" && up.UJ.Ymu) {
				...
				if (SZx >= Math.min(GY.eM, GY._k)) {
					...
					qZE /= SZx;
					if (up.q8 != Ux.CS && SZx >= GY.eM && Math.abs(qZE - GY.AO1) < GY.f0k) {
						ct.qF(up.ww, "change state to playing since PHT is moving (HTML5 Android)");
						up.cg(Ux.CS);
						return;
					}
					if (up.q8 == Ux.CS && up.kws && SZx >= GY._k && qZE == GY.wPO) {
						var _q = true;
						if (up.UJ && up.UJ.Du) {
							_q = !up.UJ.Du.kXn;
						}
			...
			if (u5 >= GY.eM && up.q8 != Ux.CS && up.UJ != null) {
				ct.qF(up.ww, "change state to playing since PHT is moving");
				up.cg(Ux.CS);
				return;
			}
			if (zG >= GY._k) {
				if (up.q8 == Ux.CS && up.P3 < kz - 1000) {
					var _q = false;
					if (up.UJ.nj() == "qt") {
		...
		function JMg(DM, Y8z) {
			...
			if (KB != VW.z_(up.ea(Y8z, "width")) || zi != VW.z_(up.ea(Y8z, "height")) || I9 != VW.z_(up.ea(Y8z, "avcprofile"))) {
				up.WH(KB, zi, I9);
			}
			var lv = jh.oIy(o6 + cP, up.Nk, ff_);
			if (up.pF != null) {
				try {
		...
		function g0(jJ) {
			...
			if (jJ == Ux.CS && !up.kws) {
				...
				Vhn = true;
				var g7 = CO.el();
				if ((up.CI.V7 && g7.hJ < g7.W1) || (!up.CI.V7 && g7.hJ < g7.Yo)) {
					up.baQ = WP.rF(g7.hJ);
				}
			}
			if (!up.zs.Wt(up.q8)) {
			...
			up.zs.a9(up.q8, up.zs.tc(up.q8) + hR.SI(up.P3, kz));
			if (up.q8 == Ux.CS && jJ != Ux.CS && up.zs.tc(Ux.CS) < up.qVe) {
				if (up.baQ != null) {
					WP.cRZ(up.baQ);
					up.baQ = null;
				}
		...
		function IAY() {
			...
			for (var Jo = 0; Jo < bC.length; Jo++) {
				var GuT = bC[Jo];
				if (GuT.vtV != null && GuT.vtV.Bt > 0) return true;
			}
			return false;
		}
		OZ(up, "Nce", kjQ);
	...
	function GyG() {
		...
		function ju(pq, nYK) {
			...
			up.LWw = new EW();
			up.XNs = null;
			O9.y8(HkZ.gQA(up.Du), "MonitorConvivaStreamerProxy(): streamerProxy is a " + up.BZ + ", which is not a type of ConvivaStreamerProxy.");
			ct.qF(up.zSS(), "Starting monitoring for a proxy of type " + up.BZ);
			Dh.YB("SetMonitoringNotifier", up.Du, up.tso);
		}
		OZ(up, "wy", NQ);
		...
		function E8n(Uy, yKu, QFN) {
			if (up.aN.kws) {
				...
				up.LJ4("playing state reported as " + Uy + " (\"" + yKu + "\"), " + "but this will be ignored because state detection is incorrect before joining", GyG.CmY, null);
				return;
			}
		}
		LK(up, "DNq", ymR);
		...
		function acM(rU, C2d) {
			...
			if (up.LWw.Wt(C2d) && up.LWw.tc(C2d) == rU) {
				return false;
			} else {
				up.LWw.a9(C2d, rU);
				return true;
		...
		function gsn(rU, C2d, gp) {
			if (up.ocW(rU, C2d)) {
				var lXM = (gp != null ? " (" + gp + ")" : "");
				O9.Ep("Bad input for the " + C2d + " component: " + rU + lXM + ".", true);
			}
		}
		LK(up, "LJ4", Z1b);
		...
		function Z1b(rU, C2d, gp) {
			if (up.ocW(rU, C2d)) {
				ct.qF(up.zSS(), "Warning: Suspicious input for the " + C2d + " component: " + rU + (gp != null ? " (" + gp + ")" : "") + ".");
			}
		}
		LK(up, "wvV", Vrt);
		...
		function Vrt(rU, C2d, gp) {
			if (up.ocW(rU, C2d)) {
				ct.qF(up.zSS(), "Input for the " + C2d + " component: " + rU + (gp != null ? " (" + gp + ")" : "") + ".");
			}
		}
		if (up != fj) ju.apply(up, arguments);
	}
	...
	function to() {
		...
		function ju(pq, G_) {
			Pz.call(up, pq, G_);
			up.vV = false;
			if (up.aN && up.aN.CI && up.aN.CI.Ay && !up.aN.CI.Ay.xQh) {
				if (up.Du && up.Du.src) {
		...
		function CC() {
			...
			if (iV.pD == "Firefox") {
				...
				if (!up.Du.seeking && !up.Du.paused && !up.Du.ended) {
					if (up.Du.readyState == up.Du.HAVE_CURRENT_DATA && zE4 >= up.Du.HAVE_FUTURE_DATA) {
	...
	function GnC() {
		...
		function ju(G_, Bii) {
			ConvivaStreamerProxy.call(up);
			up.GjQ = G_;
			Dh.HM("SU", up.GjQ, up._M1);
			Dh.HM("by", up.GjQ, up.RS);
			var mEM = function(Oo, rZ) {
					up.Yg2(Oo);
				};
			Dh.HM("IV", up.GjQ, mEM);
		...
		function lvV(k3, w6) {
			...
			var x_ = StreamerError.YKZ(SbG.Zi7(k3), StreamerError.VuW, ZTN);
			up.rpy(x_);
		}
		LK(up, "_M1", rxZ);
	...
	function XO() {
		...
		function PXz(S5, vw) {
			var lb = ("Stats: " + ((vw == null) ? "" : "Id=" + vw.JZ) + " Seq=" + S5.Nm + " S=" + S5.fF + " Tot=" + S5.Ky + " PHT=" + S5.EA + " CLSec=" + vw.cX + " TPl=" + S5.zg + " TB=" + S5.zc + " Buffer=" + S5.vG + " TPa=" + S5.rp + " TS=" + S5.LI + " AFR=" + S5.IC + " PAFR=" + S5.sb + " EFR=" + S5.jD + " J=" + S5.dv + " SRAv=" + S5._f + " SRMax=" + S5.ps + " BW=" + S5.vi + " ");
			var bC = S5.uXxz().YC;
			for (var Jo = 0; Jo < bC.length; Jo++) {
				var xk = bC[Jo];
				lb += XO.BQw(xk) + " ";
			...
			for (var wt = 0; wt < HH.length; wt++) {
				var sL = HH[wt];
				lb += "bitrateUse[" + sL.M9 + "]={ BitratePlayTime=" + sL.WR + " BitrateBufTime=" + sL.B0 + " droppedFrames=" + sL.qt + " } ";
			}
			return lb;
		}
		dN(up, XO, "BQw", c3Z);
		...
		function c3Z(yo) {
			return ("resourceUse[" + (yo.w6 != null && yo.w6.yWkn() ? oL.fg(yo.w6.kn) : "?") + "]{" + " Bytes=" + oL.fg(yo.Xt) + " ResPlayTime=" + yo.WR + " ResBufTime=" + yo.B0 + " BitrateWtSum=" + yo.iO + " } ");
		}
		dN(up, XO, "lSL", JTv);
	...
	function yqn() {
		...
		function wYW() {
			...
			var amN = new fRx();
			if (rT != null) {
				amN.rT = oL.fg(rT.uv) + "." + oL.fg(rT.wG) + "." + oL.fg(rT.VY);
			}
			if (up.Rk) {
	...
	function iV() {
		...
		function ZT3() {
			var bM8 = null; {
				bM8 = navigator && navigator.platform && navigator.platform.toString ? navigator.platform.toString() : null;
			}
			return bM8;
		}
		dN(up, iV, "KVT", mbE);
		...
		function mbE() {
			var JaK = null; {
				JaK = navigator && navigator.userAgent && navigator.userAgent.toString ? navigator.userAgent.toString() : null;
			}
			return JaK;
		}
		dN(up, iV, "US_", _Fm);
		...
		function Pxz(Vc2) {
			...
			if (oL.Pe(Vc2, "iPad") || oL.Pe(Vc2, "iPhone") || oL.Pe(Vc2, "iPod")) {
				return "IOS";
			} else if (oL.Pe(Vc2, "Mac")) {
				return "MAC";
			} else if (oL.Pe(Vc2, "Win")) {
				return "WIN";
			} else if (oL.Pe(Vc2, "Linux") || oL.Pe(Vc2, "SunOS") || oL.Pe(Vc2, "HP-UX") || oL.Pe(Vc2, "BSD")) {
				return "UNIX";
		...
		function EdM(FpE) {
			...
			} else if ((oL.Pe(FpE, "iPad") || oL.Pe(FpE, "iPhone") || oL.Pe(FpE, "iPod")) && oL.Pe(FpE, "AppleWebKit") && oL.Pe(FpE, "Mobile")) {
				lb.a9(0, "Safari");
	...
	function r9U() {
		...
		function Zdc(mG7) {
			return (" Count=" + up.Mf + mG7 + " Mean=" + up.PS + mG7 + " Min=" + up.W_h + mG7 + " Max=" + up._j + mG7 + " StdDev=" + up.So6);
		}
	}
	Bg(r9U, "r9U");
	...
	function FQ() {
		...
		function ju(bXK, kNt) {
			up._U5 = bXK;
			up.nsn = kNt;
			if (up.nsn > up._U5 / 10.0) up.nsn = up._U5 / 10.0;
			if (up.nsn < up._U5 / 1000.0) up.nsn = up._U5 / 1000.0;
			up.nr();
		}
		OZ(up, "nr", kP);
	...
	function hR() {
		...
		function ugD(h9A, JC0) {
			...
			if (hR.IX5 != null) {
				...
				for (var Jo = 0; Jo < bC.length; Jo++) {
					var zjb = bC[Jo];
					DRs += hR.iIb(h9A, JC0, zjb.pT, zjb.bAW);
				}
			}
		...
		function CBL() {
			var kz = Lt.VB();
			if (hR.oJs >= 0 && kz - hR.oJs > hR.HfQ && hR.IX5 != null) {
